...
function setDate() {
  ...
  digitalClock.textContent = now.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', second: '2-digit' }); // Thêm giây
...
function changeBackground(hours) {
  if (hours >= 6 && hours < 18) {
    background.style.backgroundImage = "url('ngay.jpg')";
  } else {
    background.style.backgroundImage = "url('dem.jpg')";
  }
}
